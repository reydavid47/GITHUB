<%@ Page Title="" Language="C#" MasterPageFile="~/SavingsChoice/SavingsChoice.master" AutoEventWireup="true" CodeFile="SavingsChoiceImaging.aspx.cs" Inherits="ClearCostWeb.SavingsChoice.SavingsChoiceImaging" %>
...
<asp:Content ID="cBody" ContentPlaceHolderID="body" Runat="Server">
    <h4 class="sqiqDisplaySteps">Step 4 of 4</h4>
    ...
    <div class="next">
        ...
        <asp:HyperLink runat="server" CssClass="continueButton" NavigateUrl="~/SavingsChoice/SavingsChoiceInterim.aspx" Text="Continue" />
    </div>
    ...
    <script type="text/javascript" language="javascript">
        ...
        _cchGlobal.pageData["pageURL"] = 'SavingsChoiceImaging.aspx';

        $(document).ready(function () {
            _cchGlobal.actions.loadPage();           
            gotoPreviousPage({
                action: 'redirect',
                goto: '/SavingsChoice/SavingsChoiceLabs.aspx'
            });
            addProvider({
                action: 'init'
            });
