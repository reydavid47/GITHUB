...
{
    public partial class SavingsChoiceMedicalProviders : System.Web.UI.Page
    {
        private string[] rateText = {                                
                                "You did not visit any medical providers in the past year.",
                                "Please rate your satisfaction with the following medical providers that you have visited."
                            };
        private DataTable ProviderAvatarXRef
        {
            get { return (DataTable)HttpContext.Current.Session["scProviderAvatarXRef"]; }
            set { HttpContext.Current.Session["scProviderAvatarXRef"] = value; }
        }
        private DataTable Providers
        {
            get { return (System.Data.DataTable)HttpContext.Current.Session["scProviders"]; }
            set { HttpContext.Current.Session["scProviders"] = value; }
        }
        private DataTable ProviderAvatars
        {
            get { return (System.Data.DataTable)HttpContext.Current.Session["scProviderAvatars"]; }
            set { HttpContext.Current.Session["scProviderAvatars"] = value; }
        }
        protected string PatientState {
            get { return ThisSession.PatientState; }
        }
        protected string PatientCity {
            get { return ThisSession.PatientCity; }
        }
