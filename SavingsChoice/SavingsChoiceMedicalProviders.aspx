<%@ Page Title="" Language="C#" MasterPageFile="~/SavingsChoice/SavingsChoice.master" AutoEventWireup="true" CodeFile="SavingsChoiceMedicalProviders.aspx.cs" Inherits="ClearCostWeb.SavingsChoice.SavingsChoiceMedicalProviders" %>
...
<asp:Content ID="cBody" ContentPlaceHolderID="body" Runat="Server">
    <h4 class="sqiqDisplaySteps">Step 2 of 4</h4>
    <h3>Getting to Know You: Medical Providers</h3>
    ...
    <div class="next">
        ...
        <asp:HyperLink runat="server" CssClass="continueButton" NavigateUrl="~/SavingsChoice/SavingsChoiceLabs.aspx" Text="Continue" />
    </div>      
    ...
    <script type="text/javascript" language="javascript">       
        ...
        _cchGlobal.pageData["newProviderCategory"] = 'mvp';
        _cchGlobal.pageData["pageURL"] = 'SavingsChoiceMedicalProviders.aspx';
        /*        
        ...
        */
        ...
        $(document).ready(function () {
            ...
            gotoPreviousPage({
                action: 'redirect',
                goto: '/SavingsChoice/SavingsChoicePharmacies.aspx'
            });
            addProvider({
                action: 'init'
            });
