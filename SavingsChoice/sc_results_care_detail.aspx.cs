...
{
    public partial class sc_results_care_detail : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                if (ThisSession.ChosenLabs == null)
                {
                    ...
                    // rld, 20131108, Replace Service Name with Specialty
                    // lblServiceName.Text = ThisSession.ServiceName.ToString();
                    // lblServiceName_MoreInfoTitle.Text = ThisSession.ServiceName.ToString();
                    lblServiceName.Text = ThisSession.Specialty.ToString();
                    lblServiceName_MoreInfoTitle.Text = ThisSession.Specialty.ToString();
        ...
        protected void PopulateFacilityinfo()
        {
            ...
            if (FacilityInfo.Rows.Count > 0)
            {
                ...
                {
                    // rld, 20131108, remove Total Estimated Cost from the page
                    //if (ThisSession.ChosenLabs == null)
                    //{
                    ...
                    if (ds.Tables.Count > 1)
                    {
                        ...
                        if (ds.Tables.Count > 2) // did we get specialty info?
                        {
                            ...
                            if (ds.Tables[2].Rows[0]["Title"].ToString() != String.Empty)
                            {
                                ...
                                lblServiceName.Text = ds.Tables[2].Rows[0]["Title"].ToString();
                            }
                            else
                            {
