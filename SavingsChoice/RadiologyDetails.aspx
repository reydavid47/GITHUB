<%@ Page Title="" Language="C#" MasterPageFile="~/SavingsChoice/Details.master" AutoEventWireup="true" CodeFile="RadiologyDetails.aspx.cs" Inherits="ClearCostWeb.SavingsChoice.RadiologyDetails" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHeader" Runat="Server">
    <div style="float: left; width: 489px;">
        <h1>Radiology Savings Choice</h1>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphContentBar" Runat="Server">     
    ...
    <h3 class="savingschoice emphasis center">RADIOLOGY FACILITIES USED RECENTLY BY YOUR FAMILY</h3>
    ...
    <h3 class="savingschoice emphasis center">FAIR PRICE RADIOLOGY FACILITIES</h3>    
    ...
    <div style="text-align: right;">
        <div class="button-gray-white-arrow-lg displayinline"><a href="<%=ResolveUrl("switch.aspx") %>?scswitch_category=<%=Category %>&scswitch_step=1" id="beginSwitchStep" rel="beginSwitchStep" class="triggeroverlay">Select a Fair Price Radiology Facility</a></div>
    </div>
    ...
    <script type="text/javascript" language="javascript">
        ...
        _cchGlobal.pageData["category"] = 'imaging';
        function prepUI() {
        ...
        //$(document).ready(function () {
            ...
            /* -- continue button saves stars if needed, then continues -- */
            continueBtn({
                action: 'init',
                element: 'div.button-gray-white-arrow-lg.displayinline'
            });
