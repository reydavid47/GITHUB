<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SavingsChoiceSwitchSteps_PrescriptionDrugs.ascx.cs" Inherits="ClearCostWeb.SavingsChoice.SavingsChoiceSwitchSteps_PrescriptionDrugs" %>
<style type="text/css">
...
<script src="<%=ResolveUrl("/Scripts/SavingsChoiceSwitchSteps.js") %>" type="text/javascript"></script>
    <div id="tabchoice" class="ui-tabs-panel ui-widget-content ui-corner-bottom">        
        <h1>Save Money on Prescription Drugs</h1>
        ...
        <asp:Panel ID="step1" runat="server" Visible="false" CssClass="stepWrapper" >           
            <p class="subhead">
                Saving money on prescription drugs is simple! We'll walk you step-by-step through the process. If you have any questions, feel free to call our Health Shoppers at (800) 390-6855.
            </p>
            <div class="subpanel">                                    
                <p class="switchquestions">
                    Which family member is this switch for?
                </p>
                <p>
                <asp:Repeater ID="step1DisplayQuestions" runat="server"></asp:Repeater>
                <select>
                    <option class="mvpsubcategories" value="">Select from list</option>
                <asp:Repeater ID="medicalSubcategories" runat="server">
                    <ItemTemplate>
                        <option class="mvpsubcategories" value="<%#DataBinder.Eval(Container.DataItem, "SubCategory")%>"> <%#DataBinder.Eval(Container.DataItem, "SubCategory")%></option>            
                    </ItemTemplate>
                </asp:Repeater>      
                </select>                    
                </p>
                <p class="switchquestions">
                    Which drug are you looking to switch to a Fair Price pharmacy?
                </p>
            ...
            <script type="text/javascript">
                function trackChoice(iData) {                    
                    /*
                    iData Structure
                    iData.item
                    */
                    var trackItem = iData.item;
                    switch (trackItem) {
                        case '#ResultsContent_cphContentBar_ctl00_step1 select':
                            $(trackItem).on('change', function () {
                                sessionStorage['mvpSubcategorySelecte'] = $(this).children(':selected').val();
                            });
                            break;
                    }
                };
                $(document).ready(function () {
                    trackChoice({
                        item:'#ResultsContent_cphContentBar_ctl00_step1 select'
                    });
                });
            </script>         
        </asp:Panel>
        <asp:Panel ID="step2" runat="server" Visible="false" CssClass="stepWrapper" >
            ...
            <asp:Repeater ID="step3DisplayQuestions" runat="server" Visible=false>
            <ItemTemplate>
                <p class="subhead"><%#DataBinder.Eval(Container.DataItem,"Optiondesc") %></p>
            </ItemTemplate>                
            </asp:Repeater>
            <p class="subhead">Nearby Fair Price facilities for {subcategory} are listed below. Please uncheck any facilities you are not interested in visiting.</p>                                    
            <div class="subpanel">
                ...
                <tbody>
                    <asp:Repeater ID="step4DisplayContent" runat="server">
                        <ItemTemplate>
                            <tr>
            ...
            <script type="text/javascript">
                ...
                function prepUI() {
                    var existingHTML = $('#ResultsContent_cphContentBar_ctl00_step2 .subhead').html();
                    var newHTML = existingHTML.replace('{subcategory}', '<strong style="font-size:1em">'+sessionStorage['mvpSubcategorySelecte']+'</strong>');
                    $('#ResultsContent_cphContentBar_ctl00_step2 .subhead').html(newHTML);
                }
                $(document).ready(function () {
                    prepUI();
                    loadHandlers();
        ...
        <asp:Panel ID="step4" runat="server" Visible="false" CssClass="stepWrapper" >
            ...
            <div class="subpanel">
            <h3 class="savingschoice">How to make an appointment with a new provider:</h3>

            <div style="margin-top: 20px;">
            <a class="plusminus listclosed">Decide which facility you'd like to go to.</a>
            ...
            <div style="margin-top: 20px;">
            <a class="plusminus listclosed">Call your preferred fair price provider and ask what information and documents they need to schedule an appointment for you. They will ask you for some personal information.</a>
            <div class="togglecontent subpanel">
            <p>
            ...
            <div style="margin-top: 20px;">
                <a class="plusminus listclosed">Have your primary care doctor transfer your health records.</a>
                <div class="togglecontent subpanel">
                    <p>A lab requisition form includes your personal information, the lab test your doctor is ordering, as well as your doctor's signature, phone and fax numbers and address.</p>
                    <p>If you already have this form, bring it with you when you visit the lab or send it via fax or email prior to your appointment.</p>
                    <p>If you do not have the form, request one from your doctor.</p>
                </div>
            </div>
            </div><!-- end subpanel -->
            <br><br>
