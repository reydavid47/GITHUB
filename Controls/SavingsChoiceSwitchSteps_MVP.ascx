<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SavingsChoiceSwitchSteps_MVP.ascx.cs" Inherits="ClearCostWeb.SavingsChoice.SavingsChoiceSwitchSteps_MVP" %>
<style type="text/css">
...
<script src="<%=ResolveUrl("/Scripts/SavingsChoiceSwitchSteps.js") %>" type="text/javascript"></script>
    <div id="tabchoice" class="ui-tabs-panel ui-widget-content ui-corner-bottom">        
        <h1>Save Money on Medical Visits & Procedues</h1>
        ...
        <asp:Panel ID="step1" runat="server" Visible="false" CssClass="stepWrapper" >           
            <p class="subhead">
                Saving money on medical visits and procedues is simple! We'll walk you step-by-step through the process. If you have any questions, feel free to call our Health Shoppers at (800) 390-6855.
            </p>
            <div class="subpanel">                                    
                ...
                <p class="switchquestions">
                    How do you want to select a new specialist?
                </p>
