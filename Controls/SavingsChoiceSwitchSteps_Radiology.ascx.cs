...
{
    public partial class SavingsChoiceSwitchSteps_Radiology : System.Web.UI.UserControl
    {
        ...
        private string category = "Imaging",
        ...
        protected string radiologySubCategory = Encoder.HtmlEncode( HttpContext.Current.Request.QueryString["selectedtype"] );
        ...
        private void loadFairPriceProviderList()
        {
            ...
            SC_GetFairPriceAlternatives fpa = new SC_GetFairPriceAlternatives();
            {
                ...
                fpa.SubCategory = radiologySubCategory;
                fpa.RowMax = 10;
                fpa.GetData();
