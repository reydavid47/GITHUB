<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SavingsChoiceSwitchSteps_Lab.ascx.cs" Inherits="ClearCostWeb.SavingsChoice.SavingsChoiceSwitchSteps_Lab" %>
<style type="text/css">
...
<script src="<%=ResolveUrl("/Scripts/SavingsChoiceSwitchSteps.js") %>" type="text/javascript"></script>
    <div id="tabchoice" class="ui-tabs-panel ui-widget-content ui-corner-bottom">        
        ...
        <asp:Panel ID="step1" runat="server" Visible="false" CssClass="stepWrapper" >           
            <p class="subhead">
                Saving money on lab tests is simple!  We'll walk you step-by-step through the process.  If you have any questions, feel free to call our Health Shoppers at (800) 390-6855.
            </p>
            <div class="subpanel">
                <p class="switchquestions">
                    How do you want to select a new laboratory?
                </p>
        ...
        <asp:Panel ID="step4" runat="server" Visible="false" CssClass="stepWrapper" >
            ...
            <a class="plusminus listclosed">Decide which laboratory you'd like to transfer your tests to.</a>
            ...
            <div style="margin-top: 20px;">
            <a class="plusminus listclosed">Call your preferred provider to make an appointment.  They will ask for some personal information.</a>
            <div class="togglecontent subpanel">
            <p>
            ...
            <div style="margin-top: 20px;">
                <a class="plusminus listclosed">Make sure you have a lab test requisition form from your doctor.</a>
                <div class="togglecontent subpanel">
