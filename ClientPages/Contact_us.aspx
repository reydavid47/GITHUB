<%@ Page Title="" Language="C#" MasterPageFile="ClientPages.master" AutoEventWireup="true" CodeFile="Contact_us.aspx.cs" Inherits="ClearCostWeb.ClientPages.Contact_us" %>
...
<asp:Content ID="Contact_us_Content" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <br />
    <asp:HiddenField ID="hfToAddress" runat="server" />
    ...
    <br />
    <br />
    <b>Phone number: </b><asp:Literal ID="ltlPhone" runat="server" />
    <br />
    <b>Hours:</b>&nbsp;Monday - Friday, 6am - 5pm PT
</asp:Content>
