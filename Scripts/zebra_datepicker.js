        ...
        var init = function (update) {
            ...
            if (!plugin.settings.always_visible) {
                ...
                */
                ...
                // position the icon accordingly
                    icon.css({
                        'left': element_position.left + element_width + 35,
                        'top': element_position.top + ((element_height - icon_height) / 2) + 25
                    });
            ...
            /* susan.  this was causing icon to be hidden since form is originally hidden 
            */
            /* if (!($element.is(':visible'))) icon.css('display', 'none'); else */ icon.css('display', 'inline');
        ...
        */
        plugin.show = function () {
            ...
            if (!plugin.settings.always_visible) {
                ...
                /* cover place
                top = icon.offset().top + plugin.settings.offset[1],
                */
